...
def test_train_difference_condition_that_should_pass():
    """
    ...
    validate_train_difference_condition_that_should_pass(
        condition_satisfying_df,
        condition_value=0.2,
        condition_generating_method="train_is_lower_by"
    )

def test_train_difference_condition_that_should_not_pass():
    """
    Testing condition generated by `TrainTestDifferenceOverfit.add_condition_train_is_lower_by` method
    """
    ...
    validate_train_difference_condition_that_should_not_pass(
...
def test_train_difference_by_factor_of_X_condition_that_should_pass():
    """
...
def test_train_difference_by_factor_of_X_condition_that_should_not_pass():
    """
    Testing condition generated by `TrainTestDifferenceOverfit.add_condition_train_is_lower_by_factor_of` method
    """
    condition_unsatisfying_df = pd.DataFrame.from_dict({
...
def validate_train_difference_condition_that_should_pass(
...
def validate_train_difference_condition_that_should_not_pass(
    condition_unsatisfying_df: pd.DataFrame,
    condition_value: float,
    condition_generating_method: TrainDifferenceCondition,
):
    """
    look at the `validate_train_difference_condition_that_should_pass` docstring
    """
    check = TrainTestDifferenceOverfit()
