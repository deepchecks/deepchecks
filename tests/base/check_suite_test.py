...
from deepchecks.tabular import Dataset, SingleDatasetCheck, Suite, TrainTestCheck, checks as tabular_checks, datasets
...
def test_select_results_with_indexes_and_names_from_suite_result():
    ...
    suite_results_by_name = suite_result.select_results(
        names=["Conflicting Labels - Train Dataset", "Outlier Sample Detection", "mixed_Nulls"]
    )
