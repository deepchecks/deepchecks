...
def test_coco_best(fake_coco_train_visiondata, fake_coco_test_visiondata, fake_trained_yolov5_object_detection, simple_formatter):
    # Arrange
    pred_formatter = DetectionPredictionFormatter(simple_formatter)
    check = ClassPerformance(n_to_show=2, show_only='best')
    # Act
    result = check.run(fake_coco_train_visiondata, fake_coco_test_visiondata,
