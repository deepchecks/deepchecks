...
def test_nan(df_with_single_nans_in_different_rows, df_with_single_nan_in_col):
    train_dataset = Dataset(
        pd.DataFrame(data=df_with_single_nans_in_different_rows, columns=["col1", "col2"]),
        cat_features=["col1", "col2"],
    )
    test_dataset = Dataset(
        pd.DataFrame(data=df_with_single_nan_in_col, columns=["col1", "col2"]), cat_features=["col1", "col2"]
    )
