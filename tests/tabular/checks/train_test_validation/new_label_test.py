...
def test_multiple_categories():
    ...
    train_dataset = Dataset(
        pd.DataFrame(data=train_data, columns=["col1", "col2"]), label="col1", label_type="multiclass"
    )
    test_dataset = Dataset(
        pd.DataFrame(data=test_data, columns=["col1", "col2"]), label="col1", label_type="multiclass"
    )
