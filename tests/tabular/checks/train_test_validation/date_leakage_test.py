...
def test_dataset_no_index():
    ...
    assert_that(
        ...
        raises(DatasetValidationError, "Dataset does not contain a datetime"),
    )
    assert_that(
...
def test_nan():
    ...
    val_ds = dataset_from_dict(
        {"col1": [datetime(2021, 10, 6, 0, 0), datetime(2021, 10, 6, 1, 0), datetime(2021, 10, 6, 2, 0), np.nan]},
        "col1",
    )
    check_obj = DateTrainTestLeakageOverlap()
    assert_that(check_obj.run(train_ds, val_ds).value, equal_to(0))
    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                is_pass=False, name="Date leakage ratio is less or equal to 17%", details="Found 18.18% leaked dates"
            )
        ),
    )
...
def test_condition_fail_on_overlap_date_in_index():
    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                is_pass=False, name="Date leakage ratio is less or equal to 17%", details="Found 27.27% leaked dates"
            )
        ),
    )
...
def test_condition_on_overlap():
    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                is_pass=True, name="Date leakage ratio is less or equal to 0%", details="No leaked dates found"
            )
        ),
    )
...
def test_condition_fail_on_duplicates():
    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                is_pass=False, name="Date leakage ratio is less or equal to 10%", details="Found 18.18% leaked dates"
            )
        ),
    )
