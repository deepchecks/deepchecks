...
def test_segment_performance_diabetes(diabetes_split_dataset_and_model):
    ...
    # Assert
    assert_that(
        result.value, has_entries({"scores": has_property("shape", (10, 2)), "counts": has_property("shape", (10, 2))})
    )
...
def test_segment_top_features(diabetes_split_dataset_and_model):
    ...
    # Assert
    assert_that(
        result, has_entries({"scores": has_property("shape", (10, 10)), "counts": has_property("shape", (10, 10))})
    )
