...
def test_no_error(adult_split_dataset_and_model, avocado_split_dataset_and_model):
    # Arrange
    tasks = [
        (*adult_split_dataset_and_model, ["sex", "age"], ["education", "capital-gain"]),
        (*avocado_split_dataset_and_model, ["type", "year"], ["region", "Total Bags"]),
    ]
...
def test_numeric_values_classwise_with_control(adult_split_dataset_and_model):
    ...
    expected_value = pd.DataFrame(
        {
            "sex": {5: " Female", 3: " Female", 4: " Female", 0: " Male", 2: " Male", 1: " Male"},
            "race": {5: "Others", 3: " White", 4: " Black", 0: " White", 2: "Others", 1: " Black"},
            "_scorer": {
                5: "f1_per_class",
                3: "f1_per_class",
                4: "f1_per_class",
            ...
            "_class": {5: " <=50K", 3: " <=50K", 4: " <=50K", 0: " >50K", 2: " >50K", 1: " >50K"},
            "_baseline": {
                5: 0.9048760991207034,
