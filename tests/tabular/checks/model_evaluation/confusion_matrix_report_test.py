...
def test_condition_misclassified_samples_lower_than_passes(iris_split_dataset_and_model):
    ...
    # Act
    check = ConfusionMatrixReport().add_condition_misclassified_samples_lower_than_condition(
        misclassified_samples_threshold=threshold
    )
...
def test_confusion_matrix_report_display(iris_split_dataset_and_model):
    ...
    assert_that(
        result.display[0],
        equal_to(
            "The overall accuracy of your model is: 91.67%.<br>Best accuracy achieved on samples with <b>"
