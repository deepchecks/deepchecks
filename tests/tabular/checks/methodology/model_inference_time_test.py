...
from deepchecks.tabular.checks.methodology import ModelInferenceTimeCheck

from tests.tabular.checks.utils import equal_condition_result, SCIENTIFIC_NOTATION_REGEXP
