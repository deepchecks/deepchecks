    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                ...
                name="The ratio between least frequent label to most frequent label " "is less than or equal 0.3",
            )
        ),
    )
    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                ...
                name="The ratio between least frequent label to most frequent label " "is less than or equal 0.1",
