...
def test_condition_count_fail():
    ...
    df = pd.DataFrame(data=data)
    # Act
    check = StringLengthOutOfBounds().add_condition_number_of_outliers_less_than_or_equal(1)
    ...
    assert_that(result, has_items(
        equal_condition_result(is_pass=False,
                               details='Found 1 out of 1 columns with number of outliers above threshold: '
                                       '{\'col1\': 2}',
                               name='Number of string length outliers is less than or equal to 1')
    ))
...
def test_condition_count_pass():
    ...
    df = pd.DataFrame(data=data)
    # Act
    check = StringLengthOutOfBounds().add_condition_number_of_outliers_less_than_or_equal(10)
    ...
    assert_that(result, has_items(
        equal_condition_result(is_pass=True,
                               ...
                               name='Number of string length outliers is less than or equal to 10')
    ))
...
def test_condition_ratio_fail():
    ...
    df = pd.DataFrame(data=data)
    # Act
    check = StringLengthOutOfBounds().add_condition_ratio_of_outliers_less_than_or_equal(0.001)
    ...
    assert_that(result, has_items(
        equal_condition_result(is_pass=False,
                               details='Found 1 out of 1 relevant columns with outliers ratio above threshold: '
                                       '{\'col1\': \'0.99%\'}',
                               name='Ratio of string length outliers is less than or equal to 0.1%',
...
def test_condition_ratio_pass():
    ...
    df = pd.DataFrame(data=data)
    # Act
    check = StringLengthOutOfBounds().add_condition_ratio_of_outliers_less_than_or_equal(0.1)
    ...
    assert_that(result, has_items(
        equal_condition_result(is_pass=True,
                               ...
                               name='Ratio of string length outliers is less than or equal to 10%')
    ))
...
def test_condition_pass_on_no_outliers():
    ...
    check = StringLengthOutOfBounds().add_condition_ratio_of_outliers_less_than_or_equal(0)
    # Act
    result = check.run(df)
    # Assert
    assert_that(result.conditions_results, has_items(
        equal_condition_result(is_pass=True,
                               details='Passed for 1 relevant column',
                               name='Ratio of string length outliers is less than or equal to 0%')
    ))
