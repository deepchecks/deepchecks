    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                is_pass=False,
                details="Found 1 out of 1 columns with number of outliers above threshold: " "{'col1': 2}",
...
def test_condition_ratio_fail():
    ...
    assert_that(
        ...
        has_items(
            equal_condition_result(
                is_pass=False,
                details="Found 1 out of 1 relevant columns with outliers ratio above threshold: " "{'col1': '0.99%'}",
