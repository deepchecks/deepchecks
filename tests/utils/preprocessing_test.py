...
def test_cat_cols_to_bins_with_max_num_categories_and_sort_by_diff():
    ...
    dist1 = np.array(list("aaabbbccd"))
    dist2 = np.array(list("aacdee"))
    res = preprocess_2_cat_cols_to_same_bins(
        dist1=dist1, dist2=dist2, max_num_categories=3, sort_by="difference", min_category_size_ratio=0
    )
...
def test_cat_cols_to_bins_with_max_num_categories_and_sort_by_raises():
    ...
    dist2 = np.array(list("aacdee"))
    assert_that(
        calling(preprocess_2_cat_cols_to_same_bins).with_args(
            dist1=dist1, dist2=dist2, max_num_categories=3, sort_by="bla"
        ),
