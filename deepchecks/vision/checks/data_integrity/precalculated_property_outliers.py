...
__all__ = ['PrecalculatedPropertyOutliers']


class PrecalculatedPropertyOutliers(AbstractPropertyOutliers):
    ...
    def __init__(self,
                 ...
                 iqr_scale: float = 1.5,
                 **kwargs):
        super().__init__(n_show_top=n_show_top, iqr_percentiles=iqr_percentiles,
                         iqr_scale=iqr_scale, properties_precalculated=True, **kwargs)
