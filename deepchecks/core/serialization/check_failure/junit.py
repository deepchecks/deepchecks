...
class CheckFailureSerializer(JunitSerializer['check_types.CheckFailure']):
    ...
    def serialize(self, encoding: str = 'utf-8', failure_tag: str = FAILURE, **kwargs) -> ET.Element:
        """Serialize a CheckFailure instance into JUnit format. In general the format is the following. The tag is
        allowed to be switched out to skipped
