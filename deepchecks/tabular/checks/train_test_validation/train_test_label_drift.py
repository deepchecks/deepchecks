...
# ----------------------------------------------------------------------------
#
"""This module contains the code that handles users' use of the deprecated TrainTestLabelDrift, which names
 was changed to LabelDrift (removed the TrainTest prefix)"""
import warnings
