...
def load_data(data_format: str = 'Dataset', as_train_test: bool = True) -> \
    ...
    Returns
    -------
    data : Union[deepchecks.Dataset, pd.DataFrame]
        the data object, corresponding to the data_format attribute.
    (train_data, test_data): tuple if as_train_test = True.
        Tuple of two objects represents the dataset splitted to train and test sets.
