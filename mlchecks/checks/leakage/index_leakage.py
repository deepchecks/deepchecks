...
def index_train_val_leakage(train_dataset: Dataset, validation_dataset: Dataset, n_index_to_show: int = 5):
    """
    ...
    validation_dataset.validate_index(index_train_val_leakage.__name__)
    ...
    if len(index_intersection) > 0:
        size_in_test = len(index_intersection) / validation_dataset.shape[0]
