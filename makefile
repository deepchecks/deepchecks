...
requirements: $(ENV)
	...
	@if [ $(OS) = "Linux" ]; \
	then \
		$(PIP) install --use-deprecated=html5lib torch==1.10.2+cpu torchvision==0.11.3+cpu torchaudio==0.10.2+cpu -f https://download.pytorch.org/whl/cpu/torch_stable.html ; \
	else \
