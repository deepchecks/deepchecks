...
requirements: $(ENV)
	...
	@if [ $(OS) = "Linux" ]; \
	then \
		$(PIP) install --use-deprecated=html5lib torch==1.10.2%2Bcpu torchvision==0.11.3%2Bcpu torchaudio==0.10.2%2Bcpu -f https://download.pytorch.org/whl/cpu/torch_stable.html ; \
	else \
