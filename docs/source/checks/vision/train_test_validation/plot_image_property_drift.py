...
check_result = ImagePropertyDrift(classes_to_display=["person", "traffic light"], min_samples=5).run(
...
check_result = ImagePropertyDrift(image_properties=properties, max_num_categories_for_drift=20).run(
    train_dataset, test_dataset
)
