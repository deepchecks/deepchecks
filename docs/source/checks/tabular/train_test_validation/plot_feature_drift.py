...
train_data = np.concatenate(
    [np.random.randn(1000, 2), np.random.choice(a=["apple", "orange", "banana"], p=[0.5, 0.3, 0.2], size=(1000, 2))],
    axis=1,
)
...
check_cond = check.add_condition_drift_score_less_than(max_allowed_categorical_score=0.2, max_allowed_numeric_score=0.1)
