...
to measure.
In order to measure the drift of the data, we can use the model's embeddings as a proxy for the data distribution.

A embeddings drift is a drift that occurs in more than one feature at a time,
