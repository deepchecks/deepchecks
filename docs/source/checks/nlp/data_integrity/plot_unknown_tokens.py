...
The Unknown Tokens check is designed to help you identify samples that contain tokens unsupported by your tokenizer.
These unsupported tokens can lead to poor model performance, as the model may not be able to understand the meaning
...
# --------------------------
#
# We see in the results that the check found many emojis and some foreign words (Korean) that are not supported by the
