...
redirects = {
    ...
    "examples/checks/distribution/*": "/examples/tabular/checks/distribution/examples/$source.html",
    "examples/checks/integrity/*": "/examples/tabular/checks/integrity/examples/$source.html",
    "examples/checks/methodology/*": "/examples/tabular/checks/methodology/examples/$source.html",
    "examples/checks/overview/*": "/examples/tabular/checks/overview/examples/$source.html",
    "examples/checks/performance/*": "/examples/tabular/checks/performance/examples/$source.html",
