...
urllib.request.urlretrieve(url, '../tutorials/hymenoptera_data.zip')

with zipfile.ZipFile('../tutorials/hymenoptera_data.zip', 'r') as zip_ref:
    zip_ref.extractall('.')
#%%
# Load Data
# ~~~~~~~~~
...
data_dir = '../tutorials/hymenoptera_data'
