...
urllib.request.urlretrieve(url, '../tutorials/tomato-detection.zip')

with zipfile.ZipFile('../tutorials/tomato-detection.zip', 'r') as zip_ref:
    zip_ref.extractall('.')
...
dataset = TomatoDataset(root=os.path.join(os.path.curdir, '../tutorials/tomato-detection/data'),
