...
:doc:`classification task </user-guide/vision/auto_tutorials/plot_classification_tutorial>` or
:doc:`object detection task </user-guide/vision/auto_tutorials/plot_detection_tutorial>`,
