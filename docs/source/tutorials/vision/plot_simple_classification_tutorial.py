...
`ClassificationData </tutorials/vision/examples/plot_classification_tutorial.html>`__ or
`DetectionData </tutorials/vision/examples/plot_detection_tutorial.html>`__. In the case of a simple classification task,
