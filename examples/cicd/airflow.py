...
import joblib
import pandas as pd
from airflow.decorators import dag, short_circuit_task, task
from airflow.providers.amazon.aws.hooks.s3 import S3Hook


@dag(
    dag_id="model_training_with_deepchecks_validation",
...
def model_training_dag():
    ...
    def validate_data(**context):
        ...
        file_name = hook.download_file(
            key=context["params"]["data_key"], bucket_name=context["params"]["bucket"], local_path="."
        )
